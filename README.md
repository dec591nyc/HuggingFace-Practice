# 🎨 結合 Hugging Face API 之繪圖生成器

本嘗試是基於 Streamlit 建立的現代化 AI 繪圖網頁，主要提供簡潔、穩定且直覺的操作實踐。
...
## 🚀 核心特色
- **免費模型**: 支援 **FLUX.1 Schnell** (多國語言) 與 **Stable Diffusion XL (SDXL)** (英文)。
- **明暗主題支持**: 提供米沙 (Beige) 淺色模式與咖啡 (Espresso) 深色模式，支援側邊欄一鍵快速切換。
- **中英語系支援**: 支援側邊欄一鍵切換**繁體中文/英文**，表單與控制項設定在語系切換時皆能妥善保留不重置。
